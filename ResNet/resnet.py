...
class ResNet(nn.Module): #ResNet50 blocks: [3, 4, 6, 3]
    ...
    def _make_layer(self, block, num_blocks, out_channels, stride):
        ...
        for i in range(num_blocks - 1):
            layers.append(block(self.in_channels, out_channels)) #in_channels: 256 -> 64
...
def test():
    net = ResNet101(image_channels=3, num_classes=1000)
